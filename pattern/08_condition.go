...
// Status (Состояние) — это поведенческий паттерн проектирования,
...
// Status реализует изменения поведения модели User в зависимости от
//состояния (роли: StatusPrivileged, StatusModerate, etc)
